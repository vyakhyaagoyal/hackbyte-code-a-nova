 ...
 */
type AllColumnsPrimaryKey<TableDef extends UntypedTableDef, Columns extends readonly string[]> = Columns extends readonly [
    infer Head extends keyof TableDef['columns'] & string,
    ...infer Tail extends readonly string[]
] ? TableDef['columns'][Head]['columnMetadata'] extends {
    isPrimaryKey: true;
} ? AllColumnsPrimaryKey<TableDef, Tail> : false : true;
/**
 ...
 */
export type Index<TableDef extends UntypedTableDef, I extends UntypedIndex<keyof TableDef['columns'] & string>> = I['unique'] extends true ? AllColumnsPrimaryKey<TableDef, I['columns']> extends true ? UniqueIndex<TableDef, I> & {
    update(row: Prettify<RowType<TableDef>>): Prettify<RowType<TableDef>>;
} : UniqueIndex<TableDef, I> : I['algorithm'] extends 'hash' ? PointIndex<TableDef, I> : RangedIndex<TableDef, I>;
/**
 ...
 */
export type ReadonlyIndex<TableDef extends UntypedTableDef, I extends UntypedIndex<keyof TableDef['columns'] & string>> = I['unique'] extends true ? ReadonlyUniqueIndex<TableDef, I> : I['algorithm'] extends 'hash' ? ReadonlyPointIndex<TableDef, I> : ReadonlyRangedIndex<TableDef, I>;
/**
 * A type representing a read-only unique index on a database table.
 */
export type ReadonlyUniqueIndex<TableDef extends UntypedTableDef, I extends UntypedIndex<keyof TableDef['columns'] & string>> = {
 ...
 */
export interface ReadonlyPointIndex<TableDef extends UntypedTableDef, I extends UntypedIndex<keyof TableDef['columns'] & string>> {
    filter(point: IndexVal<TableDef, I>): IteratorObject<Prettify<RowType<TableDef>>, undefined>;
}
/**
 * A type representing a point index on a database table.
 * Point indexes allow for exact match queries on the indexed columns.
 */
export interface PointIndex<TableDef extends UntypedTableDef, I extends UntypedIndex<keyof TableDef['columns'] & string>> extends ReadonlyPointIndex<TableDef, I> {
...
export interface ReadonlyRangedIndex<TableDef extends UntypedTableDef, I extends UntypedIndex<keyof TableDef['columns'] & string>> {
    filter(range: IndexScanRangeBounds<TableDef, I>): IteratorObject<Prettify<RowType<TableDef>>, undefined>;
}
/**
