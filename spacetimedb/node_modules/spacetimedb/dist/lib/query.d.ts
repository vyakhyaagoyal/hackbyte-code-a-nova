...
type From<TableDef extends TypedTableDef> = RowTypedQuery<RowType<TableDef>, TableDef['rowType']> & Readonly<{
    toSql(): string;
    where(predicate: (row: RowExpr<TableDef>) => PredicateExpr<TableDef>): From<TableDef>;
...
type SemijoinBuilder<TableDef extends TypedTableDef> = RowTypedQuery<RowType<TableDef>, TableDef['rowType']> & Readonly<{
    toSql(): string;
    where(predicate: (row: RowExpr<TableDef>) => PredicateExpr<TableDef>): SemijoinBuilder<TableDef>;
    /** @deprecated No longer needed — builder is already a valid query. */
    build(): Query<TableDef>;
}>;
...
export declare class ColumnExpression<TableDef extends TypedTableDef, ColumnName extends ColumnNames<TableDef>> {
    ...
    constructor(table: TableDef['sourceName'], column: ColumnName, spacetimeType: InferSpacetimeTypeOfColumn<TableDef, ColumnName>, columnName?: string);
...
type PredicateExpr<TableDef extends TypedTableDef> = BooleanExpr<TableDef> | ColumnExprForValue<TableDef, SatsBool> | boolean;
...
type RequireSameAndOrTable<Expected extends TypedTableDef, Actual extends TypedTableDef> = [Expected] extends [Actual] ? [Actual] extends [Expected] ? unknown : AndOrMixedTableScopeError : AndOrMixedTableScopeError;
export declare class BooleanExpr<Table extends TypedTableDef> {
    ...
    and<OtherTable extends TypedTableDef>(other: BooleanExpr<OtherTable> & RequireSameAndOrTable<Table, OtherTable>): BooleanExpr<Table>;
    or<OtherTable extends TypedTableDef>(other: BooleanExpr<OtherTable> & RequireSameAndOrTable<Table, OtherTable>): BooleanExpr<Table>;
    not(): BooleanExpr<Table>;
}
export declare function not<T extends TypedTableDef>(clause: BooleanExpr<T>): BooleanExpr<T>;
export declare function and<Table extends TypedTableDef, OtherTable extends TypedTableDef>(first: BooleanExpr<Table>, second: BooleanExpr<OtherTable> & RequireSameAndOrTable<Table, OtherTable>, ...rest: readonly BooleanExpr<Table>[]): BooleanExpr<Table>;
export declare function or<Table extends TypedTableDef, OtherTable extends TypedTableDef>(first: BooleanExpr<Table>, second: BooleanExpr<OtherTable> & RequireSameAndOrTable<Table, OtherTable>, ...rest: readonly BooleanExpr<Table>[]): BooleanExpr<Table>;
/**
