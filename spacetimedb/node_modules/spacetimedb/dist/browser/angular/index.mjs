import { InjectionToken, assertInInjectionContext, inject, signal, effect, computed, makeEnvironmentProviders, provideAppInitializer } from '@angular/core';
import { fromByteArray } from 'base64-js';

// src/angular/injectors/inject-spacetimedb.ts
var SPACETIMEDB_CONNECTION = new InjectionToken("SpacetimeDB Connection State");
...
export { injectReducer, injectSpacetimeDB, injectSpacetimeDBConnected, injectTable, provideSpacetimeDB };
